...
//go:generate go run go.uber.org/mock/mockgen -destination=../../../mocks/mock_health_repository.go -package=mocks -mock_names=Repository=MockHealthRepository github.com/seventeenthearth/sudal/internal/feature/health/domain Repository
